package arvores.arvoreBinariaDeBusca;
...
public class ArvoreBuscaBinaria<T extends Comparable<T>> implements
		ArvoreBinaria<T> {

	private ArvoreBuscaBinaria<T> esquerda, direita;
	private T elemento;
	...
	public void insere(T elemento) {
		...
		if (estaVazia()) {
			...
			this.esquerda = new ArvoreBuscaBinaria<T>();
			this.direita = new ArvoreBuscaBinaria<T>();
	...
	private T removeOMenorElementoDaArvore(
			ArvoreBuscaBinaria<T> arvore) {
	...
	private T procurarPaiNasSubArvores(T elemento) {
		boolean elementoDadoEhMenorQueOMeuElemento = 
			elemento.compareTo(this.elemento) < 0;
