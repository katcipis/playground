...
public class IteradorPosOrdem<T extends Comparable<T>> implements Iterator<T> {

	private final PilhaEncadeada<Object> pilha;

	public IteradorPosOrdem(ArvoreBinaria<T> arvore) {
				...
				if(ehUmaArvore){
					do{
						...
						arvoreADireitaDaDesempilhada = null;
							...
							arvoreDesempilhada = (ArvoreBinaria<T>) pilha.desempilhe();
							arvoreAEsquerdaDaDesempilhada = arvoreDesempilhada.retornaArvoreEsquerda(arvoreDesempilhada.retornaRaiz());
							arvoreADireitaDaDesempilhada = arvoreDesempilhada.retornaArvoreDireita(arvoreDesempilhada.retornaRaiz());
