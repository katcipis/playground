...
ushort IDEA_Cipher::add(long a, long b)
{
  return (ushort)((a + b) % 65536l);
}

ushort IDEA_Cipher::multiply(long a, long b)
{
  long ch, cl, c;
...
void IDEA_Cipher::encryption(ushort *X, ushort *Y, long **K)
{
...
ushort IDEA_Cipher::bits_to_ushort(ushort *bits)
{
...
void IDEA_Cipher::ushort_to_bits(ushort number, ushort *bits)
{
  ushort i, temp[16];
...
void IDEA_Cipher::cyclic_left_shift(ushort index, ushort *bits1,
                                    ushort *bits2, long **K)
{
  ushort i, j;
...
void IDEA_Cipher::encryption_key_schedule(ushort *key, long **K)
{
...
void IDEA_Cipher::extended_euclidean(long a, long b, long *x, long *y, long *d)
{
...
long IDEA_Cipher::inv(ushort ub)
{
...
void IDEA_Cipher::decryption_key_schedule(long **K, long **L)
{
  ushort r, r8, r9;
...
void IDEA_Cipher::encipher(void * data, unsigned int data_size)
{

}

void IDEA_Cipher::decipher(void * data, unsigned int data_size)
{

}

IDEA_Cipher::IDEA_Cipher() : buffer(0), buffer_size(0)
{
    db<IDEA_Cipher>(TRC) << "IDEA_Cipher()\n";
}


IDEA_Cipher::~IDEA_Cipher()
{
    db<IDEA_Cipher>(TRC) << "~IDEA_Cipher()\n";
}
