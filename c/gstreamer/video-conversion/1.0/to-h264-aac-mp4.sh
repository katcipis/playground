...
gst-launch-1.0 filesrc location=$1 ! decodebin name=decoder ! queue ! videoconvert ! subtitleoverlay font-desc="DejaVu Sans 30px" name=subtitle ! x264enc ! mp4mux name=muxer ! filesink location=$1-converted.mp4 decoder. ! audioconvert ! audioresample ! queue ! voaacenc ! muxer. filesrc location=$2 ! queue ! subparse ! subtitle.subtitle_sink
